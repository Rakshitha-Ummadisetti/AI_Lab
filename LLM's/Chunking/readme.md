This is a  browser-based tool to visualize and compare how different text chunking strategies split a document. 

What it does: Paste any text, adjust chunk size and overlap, and see how seven different strategies slice it — with chunk count, average size, and token estimates shown live. A compare view lets you see all methods side by side.
...
What I've learned:
Getting the chunking right matters the most because bad chunk boundaries directly hurt retrieval quality in RAG pipelines.
